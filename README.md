...
**[Math magicians]** project "Math magicians" is a website for all fans of mathematics. It is a Single Page App (SPA) that allows users to: - Make simple calculations. - Read a random math-related quote.<br />
...
Feel free to check the [issues page](https://github.com/zhorabay/Math-magicians/issues/)
